...
convert -background white -fill black -pointsize 22 -gravity center -font WebAkharSlim -stroke black -strokewidth .5 -size 1000x caption:@header.csv header.png
convert -background white -fill black -pointsize 22 -font WebAkharSlim -stroke black -strokewidth .2 -size 1000x caption:@paragraph.csv paragraph.png
