...
# To store gurmukhi hukamnama meaning 
meaning_gur = tables_list[3]
# To get <div> tags of header from header_paragraph
div_tags = meaning_gur.find_all('div')
...
# To write the encoded text of <p> tag into .csv file
