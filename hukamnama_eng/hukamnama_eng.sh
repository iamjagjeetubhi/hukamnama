...
convert -background white -fill black -pointsize 22 -gravity center -font FreeSerif -size 800x caption:@header.csv header.png
convert -background white -fill black -pointsize 22 -font FreeSerif -size 800x caption:@paragraph.csv paragraph.png
convert -background white -fill black -pointsize 22 -gravity center -font FreeSerif -size 800x caption:@footer.csv footer.png
